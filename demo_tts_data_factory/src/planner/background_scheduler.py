...
class BackgroundScheduler:
    ...
    def _strength_for(self, event_type: str, profile: dict[str, float]) -> float:
        base = {
            ...
            "bird_chirp": 0.26,
            "train_arrive": 0.52,
            "metro_announcement": 0.3,
            "ticket_gate_beep": 0.34,
            "station_crowd": 0.34,
            "phone_vibrate": 0.36,
            "door_knock": 0.42,
            "paper_rustle": 0.32,
    ...
    def _background_bed_strength(self, event_type: str, profile: dict[str, float]) -> float:
        base = {
            ...
            "station_crowd": 0.34,
            "train_arrive": 0.3,
            "metro_announcement": 0.22,
            "room_tone": 0.42,
            "air_conditioner_hum": 0.34,
            "fluorescent_light_hum": 0.24,
            "library_room_tone": 0.28,
            "hospital_ambience": 0.32,
